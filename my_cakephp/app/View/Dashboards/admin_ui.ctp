  ...
  <div class="box span12">
    ...
    <div class="box-content">
      <table class="table table-bordered table-striped">
          ...
          <script type="text/javascript">
			$(function() {
				$("#file_upload").uploadify({
					'swf'		: '<?php echo BASE_URL; ?>/misc/uploadify.swf',
					'uploader'  : '<?php echo BASE_URL; ?>/misc/uploadify.php',
					'folder' 	: '<?php echo BASE_URL; ?>/img/admin/uploads',
					'auto'      : true
				});
			});
		  </script>	
          <td><h3>Multiple File Upload</h3></td>
          <td><input data-no-uniform="true" type="file" name="file_upload" id="file_upload" /></td>
          <td></td>
        </tr>
        <tr>
          <td><h3>Star Rating</h3></td>
          <td><div class="raty"></div></td>
          <td><code>&lt;div class="raty"&gt;&lt;/div&gt;</code></td>
        </tr>
        <tr>
          <td><h3>Toggle Switch</h3></td>
          <td><input data-no-uniform="true" checked type="checkbox" class="iphone-toggle"></td>
          <td><code>&lt;input data-no-uniform="true" type="checkbox" class="iphone-toggle"&gt;</code></td>
        </tr>
        <tr>
          <td><h3>Auto Growing Textarea</h3></td>
          <td><textarea class="autogrow">Press enter here, it will grow automatically.</textarea></td>
          <td><code>&lt;textarea class="autogrow"&gt;&lt;/textarea&gt;</code></td>
        </tr>
        <tr>
          <td><h3>Popover</h3></td>
          <td><a href="#" class="btn btn-danger" data-rel="popover" data-content="And here's some amazing content. It's very engaging. right?" title="A Title">Hover for popover</a></td>
        ...
        <tr>
          <td><h3>Dialog</h3></td>
          <td><a href="#" class="btn btn-info btn-setting">Click for dialog</a></td>
          <td></td>
        </tr>
        <tr>
          <td><h3>Tooltip</h3></td>
          <td><a href="#" title="Tooltip, you can change the position." data-rel="tooltip" class="btn btn-warning">Hover for tooltip</a></td>
...
<div class="row-fluid sortable">
  ...
  <div class="box span7">
    ...
    <div class="box-content">
      <div class="alert alert-info"> Click buttons below to see Pop Notifications. </div>
      <p class="center">
  ...
  <div class="box span7">
    ...
    <div class="box-content">
      <ul class="ajax-loaders">
        <li><img src="<?php echo BASE_URL; ?>/img/admin/ajax-loaders/ajax-loader-1.gif" title="<?php echo BASE_URL; ?>/img/admin/ajax-loaders/ajax-loader-1.gif" ></li>
        <li><img src="<?php echo BASE_URL; ?>/img/admin/ajax-loaders/ajax-loader-2.gif" title="<?php echo BASE_URL; ?>/img/admin/ajax-loaders/ajax-loader-2.gif" ></li>
        <li><img src="<?php echo BASE_URL; ?>/img/admin/ajax-loaders/ajax-loader-3.gif" title="<?php echo BASE_URL; ?>/img/admin/ajax-loaders/ajax-loader-3.gif" ></li>
        <li><img src="<?php echo BASE_URL; ?>/img/admin/ajax-loaders/ajax-loader-4.gif" title="<?php echo BASE_URL; ?>/img/admin/ajax-loaders/ajax-loader-4.gif" ></li>
        <li><img src="<?php echo BASE_URL; ?>/img/admin/ajax-loaders/ajax-loader-5.gif" title="<?php echo BASE_URL; ?>/img/admin/ajax-loaders/ajax-loader-5.gif" ></li>
        <li><img src="<?php echo BASE_URL; ?>/img/admin/ajax-loaders/ajax-loader-6.gif" title="<?php echo BASE_URL; ?>/img/admin/ajax-loaders/ajax-loader-6.gif" ></li>
        <li><img src="<?php echo BASE_URL; ?>/img/admin/ajax-loaders/ajax-loader-7.gif" title="<?php echo BASE_URL; ?>/img/admin/ajax-loaders/ajax-loader-7.gif" ></li>
        <li><img src="<?php echo BASE_URL; ?>/img/admin/ajax-loaders/ajax-loader-8.gif" title="<?php echo BASE_URL; ?>/img/admin/ajax-loaders/ajax-loader-8.gif" ></li>
      </ul>
      <span class="clearfix">From / More <a href="http://ajaxload.info/" target="_blank">http://ajaxload.info/</a></span> </div>
  </div>
  <!--/span--> 
</div>
<!--/row-->