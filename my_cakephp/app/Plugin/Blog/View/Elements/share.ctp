<ul class="share">
  ...
  <li style="height:25px;"><iframe src="http://www.facebook.com/plugins/like.php?href=<?php echo $this->Blog->permalink($blogPost); ?>&layout=button_count" scrolling="no" frameborder="0"></iframe></li>
