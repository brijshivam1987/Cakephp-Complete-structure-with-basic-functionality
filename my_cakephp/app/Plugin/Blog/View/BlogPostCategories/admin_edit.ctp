    ...
    <div class="box span12">
        ...
        <div class="box-content">
            <?php echo $this->Form->create('BlogPostCategory',array('class' => 'form-horizontal')); ?>
              <fieldset>
                <legend>
                	<?php echo __('Edit Blog Post Category'); ?>
                	<span style="float:right;">
                    	<a  class="btn btn-danger" href="<?php echo ADMIN_URL; ?>/blog/blog_post_categories/delete/<?php echo $this->Form->value('BlogPostCategory.id'); ?>" onclick="return confirm('<?php echo 'Are you sure you want to delete # '.$this->Form->value('BlogPostCategory.id').'?'; ?>')"><i class="icon-trash"></i> Delete</a>
...
<script type="text/javascript">   
	$(document).ready(function () {
        $('#BlogPostCategoryAdminEditForm').bValidator(optionsRed);
    });
</script>
