	...
	public function admin_add() {
		...
		if ($this->request->is('post')) {
			...
			if ($this->BlogPost->save($this->request->data)) {
				$this->Session->setFlash('The blog post has been saved','message',array('class' => 'success','position' => 'top'));
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash('The blog post could not be saved. Please, try again.','message',array('class' => 'error','position' => 'top'));
			}
		}
 ...
 */
	public function admin_delete($id = null) {
		...
		if ($this->BlogPost->delete()) {
			$this->Session->setFlash('Blog post deleted','message',array('class' => 'success','position' => 'top'));
			$this->redirect(array('action'=>'index'));
		}
		$this->Session->setFlash('Blog post was not deleted. Please, try again.','message',array('class' => 'error','position' => 'top'));
		$this->redirect(array('action' => 'index'));
	}
}
